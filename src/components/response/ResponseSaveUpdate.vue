...
<div class="container">
    ...
    <div class="row" v-else>
        <div class="col-lg-9 col-sm-12 mx-auto">
            ...
            <div class="jumbotron" v-if="noQuesError">
                <div class="card">
                    <div class="card-body">
                        <div class="alert alert-danger">
                            <span>{{noQuesError}}</span>
                        </div>
                        <router-link tag="button" class="btn btn-warning mr-2" :to="{name:'Survey List'}">Back</router-link>
                    </div>
                </div>
            </div>
            <div class="jumbotron" v-else-if="details">
                <div class="card">
                    <div class="card-body">
        ...
        getQuestions(){
            ...
            .then((querySnapshot) => {
                ...
                if(this.questions.length == 0){
                    this.noQuesError = 'Sorry, There is no questions to respond!!'
                }
                this.loader = false;
            })
        },
